...
namespace System.Windows.Forms
{
	...
	[DesignTimeVisible(false), TypeConverter("System.Windows.Forms.ListViewItemConverter")]
	...
	[DesignTimeVisible(false), TypeConverter("System.Windows.Forms.SubListViewItemConverter")]
	...
	[DesignTimeVisible(false), TypeConverter("System.Windows.Forms.ToggleColumnHeaderConverter")]
	...
	public class ColumnHeaderCollection: CollectionBase
	{
		...
		public virtual int Add(System.Windows.Forms.ToggleColumnHeader colhead)
		{
		...
		public virtual void AddRange(System.Windows.Forms.ToggleColumnHeader[] items)
		{
			lock(List.SyncRoot)
			{
				for (int i=0; i< items.Length; i++)
	...
	public class ContainerListView: Control
	{
		...
		protected System.Windows.Forms.ColumnHeaderCollection columns;			
		...
		protected System.Windows.Forms.ContainerListViewItem focusedItem;	
		...
		private void Construct()
		{
			...
			columns = new System.Windows.Forms.ColumnHeaderCollection();
		...
		public System.Windows.Forms.ColumnHeaderCollection Columns
		{
			get { return columns; }
		}
		...
		public bool	VisualStyles
		{
			get 
			{
				...
				try
				{
					val = visualStyles && System.Windows.Forms.uxTheme.Wrapper.IsAppThemed();
				}
				catch
				{
					val = visualStyles;
			...
			if (headerStyle != ColumnHeaderStyle.None)
			{
				...
				try
				{
					...
					for (i=0; i<columns.Count; i++)
					{
						colwid = (columns[i].ScaleStyle == ColumnScaleStyle.Spring ? springWid : columns[i].Width);
						if (headerStyle == ColumnHeaderStyle.Clickable && columns[i].Pressed)
							System.Windows.Forms.uxTheme.Wrapper.DrawBackground("HEADER", "HEADERITEM", "PRESSED", hdc,
								lp_scr+last, tp, 
								colwid, headerBuffer,
								lp, tp, r.Width-6, headerBuffer);
						else if (headerStyle != ColumnHeaderStyle.None && columns[i].Hovered)
							System.Windows.Forms.uxTheme.Wrapper.DrawBackground("HEADER", "HEADERITEM", "HOT", hdc,
								lp_scr+last, tp, 
								colwid, headerBuffer,  
								lp, tp, r.Width-6, headerBuffer);
						else
							System.Windows.Forms.uxTheme.Wrapper.DrawBackground("HEADER", "HEADERITEM", "NORMAL", hdc,
								lp_scr+last, tp, 
								colwid, headerBuffer,  
								lp, tp, r.Width-6, headerBuffer);
						last += colwid;
					...
					{
						System.Windows.Forms.uxTheme.Wrapper.DrawBackground("HEADER", "HEADERITEM", "NORMAL", hdc, lp_scr+last, tp, r.Width-last-2+hscrollBar.Value, headerBuffer,  r.Left, r.Top, r.Width, headerBuffer);
					}
				}
				catch
				{
